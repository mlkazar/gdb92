...
#ifndef NOKAZAR
  /* this inferior's user thread list; this is where we hide user threads
   * when we're done examining state, and will restart the inferior process.
   */
  thread_info *uthread_list = nullptr;
#endif
