...
#ifndef NOKAZAR
/* This function takes a target specific thread (kazar_thread) and
 * copies the registers into the regcache in the thread_info.
 */
void
uthread_propagate_registers( thread_info *thrp, kazar_thread *kthrp)
{
  ...
  if (!regcachep) {
    printf("uthread_propagate_registers: can't find registers for pid\n");
    return;
  }
